...
class User{
    function getUsers(){
        ...
        $sql = "SELECT usr_id, usr_username, usr_fullname FROM gasowners ORDER BY usr_fullname";
    ...
    function signup($json){
        ...
        $sql = "INSERT INTO gasowners(usr_username, usr_password, usr_fullname) ";
    ...
    function login($json){
        ...
        $sql = "SELECT usr_id, usr_username, usr_fullname FROM gasowners ";
